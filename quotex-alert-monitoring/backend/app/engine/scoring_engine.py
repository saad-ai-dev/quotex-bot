...
class ScoringEngine:
    ...
    def _compute_penalties(
        ...
        if score_diff < 8.0:
            conflict_penalty = (8.0 - score_diff) * 1.2
        ...
        if chop_prob > 0.65:
            chop_penalty = (chop_prob - 0.65) * 25.0
