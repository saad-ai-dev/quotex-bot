/**
 * Quotex Alert Monitor - Overlay Renderer
 * ALERT-ONLY: Displays a small status indicator on the Quotex page corner.
 */
...
export class OverlayRenderer {
  ...
  setLastDirection(direction: SignalDirection | null): void {
  ...
  private render(): void {
    ...
    const dotColor = this.connected ? "#2ecc71" : "#e74c3c";
    ...
    this.container.innerHTML = `
      <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px;">
        <span style="display:inline-block;width:7px;height:7px;border-radius:50%;background:${dotColor};flex-shrink:0;${this.connected ? "box-shadow:0 0 4px rgba(46,204,113,0.6);" : ""}"></span>
